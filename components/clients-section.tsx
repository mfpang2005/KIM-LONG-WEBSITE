  ...
  return (
    <section id="clients" className="py-24 bg-secondary/30 overflow-hidden">
      <div className="container mx-auto px-6">
        ...
        <div className="relative flex overflow-hidden w-full max-w-[100rem] mx-auto py-2">
          {/* 边缘渐变遮罩 */}
          <div className="absolute inset-y-0 left-0 w-8 md:w-32 bg-gradient-to-r from-secondary/30 to-transparent z-10 pointer-events-none" />
          ...
          >
            {[...testimonials, ...testimonials].map((testimonial, index) => (
              <div
                key={index}
                className="bg-card border border-border rounded-2xl p-5 w-[280px] md:w-[320px] flex-shrink-0 relative flex flex-col justify-between shadow-sm hover:shadow-md transition-shadow"
              >
                ...
                <div>
                  ...
                  <p className="text-foreground font-semibold text-[13px] md:text-sm mb-4 leading-relaxed line-clamp-6">
                    {`"${testimonial.content}"`}
                  </p>
                </div>
                ...
                <div className="flex items-center gap-3 border-t border-border pt-3 mt-1">
                  ...
                  <div>
                    <p className="font-extrabold text-foreground text-[13px]">{testimonial.name}</p>
