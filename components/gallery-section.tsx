  ...
  return (
    <section id="gallery" className="py-24 bg-background">
      <div className="container mx-auto px-6">
        ...
        {/* Grid Layout */}
        <motion.div layout className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6">
            ...
            {filteredItems.map((item, index) => (
              ...
              >
                ...
                <div className="relative aspect-[4/3] w-full overflow-hidden bg-secondary">
                  ...
                  {/* Tags */}
                  {item.tag && (
                    <span className="absolute top-3 left-3 inline-flex items-center gap-1 bg-primary/95 text-primary-foreground text-[10px] md:text-xs font-bold px-2 py-1 rounded-md backdrop-blur-sm shadow-md">
                ...
                <div className="p-4 md:p-5 flex-1 flex flex-col justify-between">
                  <div className="space-y-1.5">
                    <span className="text-[10px] md:text-xs text-primary font-bold tracking-widest uppercase">
                    ...
                    <h3 className="text-base md:text-lg font-bold text-foreground group-hover:text-primary transition-colors leading-tight line-clamp-1">
                      {lang === "en" ? item.title : item.chineseTitle}
                    </h3>
                    <p className="text-[12px] md:text-sm text-muted-foreground leading-relaxed line-clamp-2">
                  ...
                  <div className="mt-4 pt-3 border-t border-border flex items-center justify-between">
                    ...
                    <div className="inline-flex items-center gap-1 text-primary text-[10px] md:text-xs font-bold group-hover:underline">
