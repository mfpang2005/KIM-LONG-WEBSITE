...
const corporateBentoMenus: BentoItem[] = [
  {
    ...
    chineseItems: [
      ...
      "金沙流心咸蛋香脆鸡扒 (Salted Egg Chicken)",
      "清炒大蒜脆绿有机小白菜 (Garlic Greens)",
      "清香丝苗茉莉白米饭 (Jasmine Rice)",
    ],
  },
  {
    ...
    price: "RM 19 / BOX",
    chinesePrice: "RM 19 / 每盒",
    badge: "Most Popular",
    chineseBadge: "高管首选",
    items: [
      "Signature Handcrafted Pipa Duck",
      "Nestum Crispy Fish Fillet",
